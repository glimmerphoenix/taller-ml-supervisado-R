...
![Esquema que explica el procedimiento de validación cruzada con `k` conjuntos. Fuente: Sec. 2.4.1 de [@boehmke2019].](img/cv-boehmke.png){#fig-cv-process width=75%}
...
![Esquema que explica el procedimiento de *bootstrapping*. Fuente: Sec. 2.4.2 de [@boehmke2019].](img/bootstrap-scheme.png){#fig-boostraping width=75%}
